...
import { BookOpen, UploadSimple, Code, ArrowRight, CheckCircle } from '@phosphor-icons/react';
          ...
          <div className="flex flex-col md:flex-row">
            <div className="flex-1 p-10 border-r border-white/5">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input type="text" defaultValue="Support Agent"
                ...
                <div>
                  ...
                  <textarea rows={3} defaultValue="Hi! I'm trained on the full documentation. How can I help?"
            ...
            <div className="w-full md:w-80 bg-black p-8 flex items-end justify-center">
              <div className="w-full max-w-[240px] bg-[#0a0a0a] rounded-xl border border-white/10 flex flex-col overflow-hidden shadow-2xl">
                <div className="h-12 bg-white text-black px-4 flex items-center font-bold text-sm tracking-tight">Support Agent</div>
                <div className="flex-1 p-4 bg-[#050505] min-h-[150px]">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-xl rounded-tl-none text-xs text-white/70 w-[85%]">
                    Hi! I'm trained on the full documentation. How can I help?
                  </div>
                </div>
          ...
          <div className="p-10">
            ...
            <div className="border border-white/10 rounded-xl overflow-hidden mb-10 bg-black">
              ...
              <div className="p-8">
                ...
                <div className="flex gap-3">
                  <input type="url" placeholder="https://example.com/docs"
                  ...
                  <button className="px-8 py-3 bg-white text-black rounded-lg font-bold hover:bg-gray-200 transition-colors shrink-0">
                    Sync
                  </button>
                </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setStep(3)}
                className="flex items-center gap-2 px-8 py-3 bg-white/5 border border-white/10 text-white rounded-lg font-bold hover:bg-white/10 transition-colors group">
        ...
        {step === 3 && (
          <div className="p-12 text-center">
            ...
            <div className="bg-black border border-white/10 rounded-xl p-6 text-left overflow-x-auto mb-10 font-mono text-sm shadow-inner">
              ...
              <div className="pl-4 text-blue-300">{'src='}<span className="text-green-300">{"\"https://app.docwise.ai/widget.js\""}</span></div>
            ...
            <div className="flex justify-center gap-4">
              <button className="px-8 py-3 bg-white/5 border border-white/10 text-white rounded-lg font-bold hover:bg-white/10 transition-colors">
                Copy Code
              </button>
              <button onClick={() => router.push('/dashboard/chatbots/1')}
